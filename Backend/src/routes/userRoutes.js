...
router.get("/verify-data", verificarToken,userController.verifyTokenByUser);
...
router.get("/usuario/valorar", verificarToken, userController.consultarVentasParaValorar);
